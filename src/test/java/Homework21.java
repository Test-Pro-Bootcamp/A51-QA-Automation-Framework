...
public void renamePlaylist(){
    ...
    public void contextClickPlaylist() {
        ...
        WebElement playlist = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='playlists']/ul/li[4]")));
        actions.contextClick(playlist).perform();

    }
    public void clickEdit(){
        WebElement edit=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='playlists']/ul/li[4]/nav/ul/li[1]")));
